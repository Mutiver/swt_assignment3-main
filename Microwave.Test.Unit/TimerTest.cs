...
namespace Microwave.Test.Unit
{
    ...
    public class TimerTest
    {
        ...
        [TestCase(0, TestName = "AddZeroMinutes")]
		[TestCase(60, TestName = "AddMinute")]
        [TestCase(120, TestName = "AddTwoMinutes")]
        [TestCase(180, TestName = "AddThreeMinutes")]
		[Test]
        public void AddTime_TimeRemainingCorrect(int time)
        {
            uut.AddTime(time);
