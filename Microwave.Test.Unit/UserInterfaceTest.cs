...
namespace Microwave.Test.Unit
{
    ...
    public class UserInterfaceTest
    {
        ...
        [Test]
        public void Cooking_CookingIsDone_BuzzerActivated()
        {
            powerButton.Pressed += Raise.EventWith(this, EventArgs.Empty);
            // Now in SetPower
            timeButton.Pressed += Raise.EventWith(this, EventArgs.Empty);
        ...
        [TestCase(0, TestName = "CookingState_OnceTimerButton")]
		[TestCase(1, TestName = "CookingState_OnceTimerButton")]
        [TestCase(2, TestName = "CookingState_OnceTimerButton")]
        [TestCase(4, TestName = "CookingState_OnceTimerButton")]
		[Test]
        public void CookingState_TimerButtonPressedWhileCooking(int times)
        {
			powerButton.Pressed += Raise.EventWith(this, EventArgs.Empty);
			// Now in SetPower
			timeButton.Pressed += Raise.EventWith(this, EventArgs.Empty);
            ...
            cooker.Received(times).AddTimeToTimer();
		}
